...
import { FiChevronsDown, FiFacebook, FiInstagram, FiLinkedin } from 'react-icons/fi';
    ...
    <main className='containerMain'>
      ...
      <section className='limit-width why-container'>
        ...
        <div>
          ...
          <p>Nossa equipe possui ampla experiência e expertise em investimentos para garantir o melhor serviço aos nossos clientes.</p>
        </div>
        <div>
          <h3>Compromisso com o Sucesso</h3>
          <p>Estamos comprometidos com o sucesso financeiro dos nossos clientes, priorizando sua satisfação e sucesso.</p>
        </div>
        <div>
          <h3>Transparência e Confiança</h3>
          <p>Valorizamos a transparência em todas as nossas interações, fornecendo informações claras e orientação honesta.</p>
        </div>
      </section>
